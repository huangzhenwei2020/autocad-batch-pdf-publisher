...
namespace BatchPdfPublisher.Views
{
    ...
    public sealed class DrawingScaleForm : DpiAwareForm
    {
        ...
        {
            Text = "万落_制图比例修改"; StartPosition = FormStartPosition.CenterScreen; FormBorderStyle = FormBorderStyle.Sizable; MaximizeBox = false; MinimizeBox = false; ClientSize = new Size(250, 625); MinimumSize = new Size(250, 520); Font = new Font("Microsoft YaHei UI", 9F); BackColor = Color.White; AutoScroll = true;
