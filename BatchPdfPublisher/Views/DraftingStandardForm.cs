...
namespace BatchPdfPublisher.Views
{
    public sealed class DraftingStandardForm : Form
    {
        ...
        private TabPage MakeDimensionTab()
        {
            ...
            var text = SubPage("文字"); var p3 = SettingPanel(4); AddPair(p3, 0, "文字高度（1:1）", _dimTextHeight, "文字颜色", _dimensionTextColor); AddPair(p3, 1, "文字与尺寸线间距", _dimensionTextGap, "文字样式", new Label { Text = "使用“标注”文字样式", AutoSize = true }); AddPair(p3, 2, "垂直位置", _dimensionTextVertical, "水平位置", _dimensionTextHorizontal); text.Controls.Add(p3);
        ...
        private void LoadProfile(DraftingStandardProfile profile)
        {
            ...
            _dimensionTextVertical.Text = profile.DimensionTextVertical; _dimensionTextHorizontal.Text = profile.DimensionTextHorizontal;
        ...
        private void Save(bool apply, ApplyScope scope = ApplyScope.All)
        {
            try
            {
                ...
                _profile.DimensionTextVertical = _dimensionTextVertical.Text; _profile.DimensionTextHorizontal = _dimensionTextHorizontal.Text;
