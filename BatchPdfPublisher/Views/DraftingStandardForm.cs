...
namespace BatchPdfPublisher.Views
{
    public sealed class DraftingStandardForm : Form
    {
        ...
        private readonly ComboBox _dimensionArrowStyle = Combo(new[] { "实心闭合", "空心闭合", "建筑斜线", "点" });
        ...
        private TabPage MakeDimensionTab()
        {
            ...
            var text = SubPage("文字"); var p3 = SettingPanel(3); AddPair(p3, 0, "文字高度（1:1）", _dimTextHeight, "文字颜色", _dimensionTextColor); AddPair(p3, 1, "文字与尺寸线间距", _dimensionTextGap, "文字样式", new Label { Text = "使用“标注”文字样式", AutoSize = true }); text.Controls.Add(p3);
