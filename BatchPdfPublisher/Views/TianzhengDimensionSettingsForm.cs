...
namespace BatchPdfPublisher.Views
{
    public sealed class TianzhengDimensionSettingsForm : Form
    {
        ...
        {
            Text = "标注比例设置（1:1 基准）"; StartPosition = FormStartPosition.CenterParent; FormBorderStyle = FormBorderStyle.FixedDialog; MaximizeBox = false; MinimizeBox = false; ClientSize = new Size(500, 335); Font = new Font("Microsoft YaHei UI", 9F);
            ...
            var note = new Label { Text = "普通 CAD 标注会同步采用最内层界线长度和相邻尺寸线间距；天正标注继续按原尺寸界线长度自动分层。", AutoSize = true, ForeColor = Color.DimGray, MaximumSize = new Size(265, 0) }; root.Controls.Add(note, 0, 3); root.SetRowSpan(note, 3);
