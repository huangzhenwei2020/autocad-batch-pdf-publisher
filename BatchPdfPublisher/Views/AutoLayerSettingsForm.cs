...
namespace BatchPdfPublisher.Views
{
    public sealed class AutoLayerSettingsForm : Form
    {
        ...
        {
            Text = "自动归层与文字样式设置"; StartPosition = FormStartPosition.CenterScreen; FormBorderStyle = FormBorderStyle.FixedDialog; MaximizeBox = false; MinimizeBox = false; ClientSize = new Size(540, 410); Font = new Font("Microsoft YaHei UI", 9F); BackColor = Color.White;
