...
{
    internal sealed class DoorWindowBatchConstructionForm : Form
    {
        ...
        {
            Text = "批量修改门窗构造"; StartPosition = FormStartPosition.CenterParent; FormBorderStyle = FormBorderStyle.FixedDialog; MaximizeBox = false; MinimizeBox = false; ClientSize = new Size(535, 245); Font = new Font("Microsoft YaHei UI", 9F);
            _doorType.Items.AddRange(new object[] { "N型", "口型" }); _doorType.SelectedIndex = 0;
            var table = new TableLayoutPanel { Dock = DockStyle.Top, Height = 180, Padding = new Padding(16, 14, 16, 4), ColumnCount = 5, RowCount = 5 };
