...
namespace BatchPdfPublisher.Views
{
    ...
    public sealed class ProjectManagerForm : Form
    {
        ...
        private readonly Label _folder = new Label();
        ...
        private void Build()
        {
            ...
            _folder.AutoSize = true; _folder.MaximumSize = new Size(420, 45); _folder.ForeColor = Color.FromArgb(71, 92, 122); _folder.Margin = new Padding(0, 10, 0, 6); right.Controls.Add(_folder, 0, 2);
        ...
        private void UpdateSelection()
        {
            ...
            _folder.Text = "项目文件夹：\r\n" + _viewModel.GetProjectFolder(project);
        }
        ...
        {
            var button = new Button { Text = text, AutoSize = true, FlatStyle = FlatStyle.Flat, Padding = new Padding(7, 3, 7, 3), Margin = new Padding(0, 0, 6, 5) };
            button.FlatAppearance.BorderColor = accent ? Color.FromArgb(34, 116, 210) : Color.FromArgb(190, 201, 216);
            if (accent) { button.BackColor = Color.FromArgb(34, 116, 210); button.ForeColor = Color.White; }
