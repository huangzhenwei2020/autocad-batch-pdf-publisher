...
namespace BatchPdfPublisher.Views
{
    ...
    /// </summary>
    internal sealed class DoorWindowLayoutPreviewForm : Form
    {
        ...
        public DoorWindowLayoutPreviewForm(IList<DoorWindowScheduleItem> items, int drawingScale, FrameDefinition selectedFrame, bool includeSchedule, bool includeNotes, bool useTianzhengTitle)
        {
            ...
            var hint = new Label { Text = "边距与页间距为纸面毫米；确认后回到 CAD 指定图框插入点（可回车跳过框选排版区，用图框默认内容区）。", AutoSize = true, ForeColor = Color.DimGray, Margin = new Padding(10, 6, 0, 0) };
